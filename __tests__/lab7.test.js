describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const shadowRoot = await items.evaluateHandle((el) => el.shadowRoot);
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    {
      const shadowRoot = await items[i].evaluateHandle((el) => el.shadowRoot);
      const button = await shadowRoot.$('button');
      const innerText = await button.getProperty('innerText'); 
      const buttonText = await innerText.jsonValue(); 
  ...
  it('Checking number of items in cart on screen after reload', async () => {
     ...
     */
      ...
      const countCart = await page.$eval('#cart-count', (el) => el.innerText);
